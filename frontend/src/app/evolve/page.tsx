...
import { getEvolutionOptions } from "@/systems/evolution";
                ...
                <div className="space-y-4">
                  {options.map((option) => (
                    <button
                      ...
                      className={`w-full rounded-xl border px-4 py-4 text-left transition ${selectedPath === option.id ? "border-[var(--text-primary)] bg-[rgba(212,197,160,0.08)]" : "border-[var(--border-dim)] bg-[rgba(255,255,255,0.02)]"}`}
                    >
